...
public class ParserTests {
	...
	public void shouldParse2() {
		...
		assertEquals(
				rcl.toString(),
				"(event: (action: move) (entity: (color: blue) (type: cube)) (destination: (spatial-relation: (relation: above) (entity: (color: red) (type: cube)))))");
	}
	...
	public void shouldParse4() {
		...
		assertEquals(
				node,
				Node.fromString("(entity: (indicator: front) (indicator: left) (type: corner))"));
	}
	...
	public void shouldParse8() {
		...
		assertEquals(
				node,
				Node.fromString("(sequence: (event: (action: take) (entity: (color: green) (type: prism))) (event: (action: move) (destination: (spatial-relation: (indicator: above) (entity: (color: red) (type: cube))))))"));
	}
	...
	public void shouldParse9() {
		...
		assertEquals(
				node,
				Node.fromString("(event: (action: move) (entity: (color: red) (type: prism)) (destination: (spatial-relation: (indicator: above) (entity: (color: cyan) (type: cube)))))"));
	}
