...
public class Lexicon {
	...
	static {
		...
		add("blocks", "(Object block (Number plural))");
		add("blue", "(Color blue)");
		...
		add("bricks", "(Object block (Number plural))");
		add("but", "(Conjunction but)");
		add("by", "(SpatialRelation at)");
		add("cell", "(Object tile)");
		add("cells", "(Object tile (Numer plural))");
		...
		add("columns", "(Object column (Number plural))");
		add("cone", "(Object prism)");
		add("corner", "(Object corner)");
		add("cube", "(Object block)");
		add("cubes", "(Object block (Number plural))");
		...
		add("row", "(Object row)");
		add("rows", "(Object row (Number plural))");
		...
		add("spaces", "(Object tile (Numer plural))");
		add("square", "(Object tile)");
		add("squares", "(Object tile (Numer plural))");
		add("stack", "(Object stack)");
		add("stacks", "(Object stack (Number plural))");
		add("step", "(Object tile)");
		add("steps", "(Object tile (Numer plural))");
		...
		add("towers", "(Object stack (Number plural))");
		add("triangle", "(Object prism)");
		add("triangles", "(Object prism (Number plural))");
