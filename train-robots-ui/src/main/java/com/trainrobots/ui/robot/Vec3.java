...
public static Vec3 cross(Vec3 v0, Vec3 v1)
  {
    return new Vec3(v0.y*v1.z - v1.y*v0.z,
                    v0.z*v1.x - v1.z*v0.x,
                    v0.x*v1.y - v1.x*v0.y);
  }
...
public static Vec3 mul(Vec3 v, Mat44 m)
  {
    return new Vec3(v.x*m.get(0, 0) + v.y*m.get(1, 0) + v.z*m.get(2, 0) + m.get(3, 0),
                    v.x*m.get(0, 1) + v.y*m.get(1, 1) + v.z*m.get(2, 1) + m.get(3, 1),
                    v.x*m.get(0, 2) + v.y*m.get(1, 2) + v.z*m.get(2, 2) + m.get(3, 2));
  }
  ...
  {
    if(Math.abs(x) < 0.000001f) x = 0.0f;
    if(Math.abs(y) < 0.000001f) y = 0.0f;
    if(Math.abs(z) < 0.000001f) z = 0.0f;
  }
