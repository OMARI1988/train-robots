...
public class RobotControlDialog extends JDialog implements ActionListener
{
  ...
  public RobotControlDialog(Frame parent, RobotControl rc)
  {
    ...
    p.add(m_buttons[0]); m_buttons[0].addActionListener(this);
    p.add(m_buttons[1]); m_buttons[1].addActionListener(this);
    add(p);
  }
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
      int x = m_scrollbars[0].getValue(),
          y = m_scrollbars[1].getValue(),
          z = m_scrollbars[2].getValue();
