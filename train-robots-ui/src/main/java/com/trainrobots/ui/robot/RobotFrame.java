                                                         ...
                                                         WindowListener
{
  ...
  private RobotControlDialog m_control; // user interface for moving the robot arm
  ...
  public void  mouseDragged(MouseEvent e)
  {
    int dx = e.getX() - m_x,
    dy = e.getY() - m_y;
    float mx = ((float)dx)/m_width,
    my = ((float)dy)/m_height;
  ...
  public void mouseMoved(MouseEvent e) { m_x = e.getX(); m_y = e.getY(); }
