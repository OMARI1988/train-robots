...
public class Material
{
  ...
  public float[] getAmbient() { return m_amb; }
  public float[] getDiffuse() { return m_diff; }
  public float[] getSpecular() { return m_spec; }
  public float getShininess() { return m_shininess; }
  
  public void setAmbient(float r, float g, float b, float a)
  { m_amb[0] = r; m_amb[1] = g; m_amb[2] = b; m_amb[3] = a; }
  
  public void setDiffuse(float r, float g, float b, float a)
  { m_diff[0] = r; m_diff[1] = g; m_diff[2] = b; m_diff[3] = a; }
